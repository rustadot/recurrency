...
//! Autogenerated weights for `pallet_recurrency_tx_payment`
//!
...
//! WASM-EXECUTION: `Compiled`, CHAIN: `Some("recurrency-bench")`, DB CACHE: `1024`

// Executed Command:
// ./scripts/../target/release/recurrency
// benchmark
// pallet
// --pallet=pallet_recurrency-tx-payment
// --extrinsic
// *
...
// --steps=20
// --repeat=10
// --output=./scripts/../pallets/recurrency-tx-payment/src/weights.rs
...
/// Weight functions needed for `pallet_recurrency_tx_payment`.
pub trait WeightInfo {
	fn pay_with_capacity() -> Weight;
	fn pay_with_capacity_batch_all(n: u32, ) -> Weight;
}

/// Weights for `pallet_recurrency_tx_payment` using the Substrate node and recommended hardware.
